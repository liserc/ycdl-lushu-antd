...

  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '附近热点', keepAlive: false, icon: 'form' }
      },
      {
...

      {
        ...
        meta: { title: '热门路线', keepAlive: false, icon: 'profile' }
      },
      {
        path: '/route/details/:id',
        name: 'routedetails', // src/views/lushu/route/RouteDisplay
        component: () => import('@/views/lushu/route/DetailsMap'),
